...
// 朝暮云API端点
const zhaomuApi = {
  getRegions: () => getApiUrl('_controller=admin_api&_action=getRegions'),
  getAllRegions: () => getApiUrl('_controller=admin_api&_action=getAllRegions'),
  getProductsByRegion: (regionId: string) => getApiUrl(`_controller=admin_api&_action=getProductsByRegion&regionId=${regionId}`),
  cacheCountries: () => getApiUrl('_controller=admin_api&_action=cacheCountries'),
  getSelectedCountries: () => getApiUrl('_controller=admin_api&_action=getSelectedCountries'),
  checkCacheKey: () => getApiUrl('_controller=admin_api&_action=checkCacheKey'),
  saveApiKey: () => getApiUrl('_controller=admin_api&_action=saveApiKey'),
  getSalesDiscount: () => getApiUrl('_controller=admin_api&_action=getSalesDiscount'),
  setSalesDiscount: () => getApiUrl('_controller=admin_api&_action=setSalesDiscount'),
  getExchangeSettings: () => getApiUrl('_controller=admin_api&_action=getExchangeSettings'),
  setExchangeSettings: () => getApiUrl('_controller=admin_api&_action=setExchangeSettings'),
  getAllConfig: () => getApiUrl('_controller=admin_api&_action=getAllConfig'),
  getProductPrice: (params: any) => {
    const queryString = new URLSearchParams(params).toString()
    return getApiUrl(`_controller=admin_api&_action=getProductPrice&${queryString}`)
  },
  searchUsers: (params: any) => {
    const queryString = new URLSearchParams(params).toString()
    return getApiUrl(`_controller=admin_api&_action=searchUsers&${queryString}`)
  },
  ...
  getOrderList: (params: any) => {
    const queryString = new URLSearchParams(params).toString()
    return getApiUrl(`_controller=admin_api&_action=getOrderList&${queryString}`)
  },
  updateOrderStatus: () => getApiUrl('_controller=admin_api&_action=updateOrderStatus'),
  continueProcessing: () => getApiUrl('_controller=admin_api&_action=continueProcessing')
}
